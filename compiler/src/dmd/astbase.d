...
struct ASTBase
{
    ...
    extern (C++) final class UnitTestDeclaration : FuncDeclaration
    {
        ...
        extern (D) this(const ref Loc loc, Loc endloc, StorageClass stc, char* codedoc, const(char)[] name)
        {
    ...
    extern (C++) final class Parameter : ASTNode
    {
	    ...
	    final extern (D) this(StorageClass storageClass, Type type, Identifier ident, Expression defaultArg, UserAttributeDeclaration userAttribDecl, UnpackDeclaration unpack)
        ...
        {
            return new Parameter(storageClass, type ? type.syntaxCopy() : null, ident, defaultArg ? defaultArg.syntaxCopy() : null, userAttribDecl ? userAttribDecl.syntaxCopy(null) : null, unpack ? unpack.syntaxCopy(null) : null);
        }
        ...
        extern (D) this(Expressions* exps)
        {
            ...
            if (exps)
            {
                for (size_t i = 0; i < exps.length; i++)
                {
                    ...
                    auto arg = new Parameter(STC.undefined_, e.type, null, null, null, null);
                    (*arguments)[i] = arg;
                }
            }
            this.arguments = arguments;
